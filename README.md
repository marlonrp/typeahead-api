...
- **performance**: we won't expect the most performant solution possible, nor early optimizations, but we do expect you to be mindful of performance when writing code.
